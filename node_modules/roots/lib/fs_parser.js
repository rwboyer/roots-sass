...
(function() {
  var FSParser, File, W, _, fs, mm, path, pipeline, readdirp;
  ...
  FSParser = (function() {
    ...
    parse_dir = function(dir) {
      ...
      readdirp({
        ...
        return function(f) {
          ...
          file = parse_file.call(_this, f.fullPath);
    ...
    parse_file = function(file) {
      ...
      list = (function() {
        ...
        for (j = 0, len = ref.length; j < len; j++) {
          ext = ref[j];
          if (ext.fs) {
            results.push(sort.bind(this, ext, file));
          }
        }
        return results;
      }).call(this);
    ...
    sort = function(ext, file, extract) {
      ...
      if (typeof extfs !== 'object') {
        this.roots.bail(125, 'fs function must return an object');
      }
      return W.resolve(extfs.detect(file)).then((function(_this) {
        return function(detected) {
          ...
          cat = (ref = extfs.category) != null ? ref : ext.category;
          if ((base = _this.ast)[cat] == null) {
            base[cat] = [];
          }
          if (!_.includes(_this.ast[cat], file)) {
